...
double measure_temp() {
    ...
    double temp = static_cast<double>(sensorInput) / 1024;
...
double measure_distance_front() {
    ...
    distance = static_cast<int>(frontDuration*0.034/2);
    delay(10);
    return distance;
}
...
double measure_distance_right() {
    ...
    distance = static_cast<int>(rightDuration*0.034/2);
    delay(10);
    return distance;
}
...
void setup() {
    ...
    length = static_cast<int>(y1 + y2);

    width = static_cast<int>(x1 + x2);
...
void loop() {
    ...
    if (pass) {
        ...
        if (test > distancetoStop) {
            if (dir == 1) {
                int yPos = length - static_cast<int>(measure_distance_front());
                int xPos = static_cast<int>(measure_distance_right());
                Serial.print(xPos);
                Serial.print(",");
                Serial.print(yPos);
                Serial.print(",");
                ...
                int xPos = width- static_cast<int>(measure_distance_front());
                int yPos = length - static_cast<int>(measure_distance_right());
                Serial.print(xPos);
                Serial.print(",");
                Serial.print(yPos);
                Serial.print(",");
                ...
                int yPos = static_cast<int>(measure_distance_front());
                int xPos = width - static_cast<int>(measure_distance_right());
                Serial.print(xPos);
                Serial.print(",");
                Serial.print(yPos);
                Serial.print(",");
                ...
                int xPos = static_cast<int>(measure_distance_front());
                int yPos = static_cast<int>(measure_distance_right());
                Serial.print(xPos);
                Serial.print(",");
                Serial.print(yPos);
                Serial.print(",");
